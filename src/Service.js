  ...
  return (
    <div className='service component__space' id='Service'>
      <div className='heading'>
          <h1 className='heading'>My Awsome Service</h1>
          <p className='heading p__color'>A Software Developer designs and builds computer programs that </p>
          <p className='heading p__color'>power mobile devices, desktop computers, and even cars.</p>
      </div>
          ...
          <div className='col__3'>
                  <div className='service__box pointer'>
                    ...
                    <div service__meta>
                        ...
                        <p className='p service__text p__color'>
                            and builds computer programs that
                        </p>
                        <p className='p service__text p__color'>
